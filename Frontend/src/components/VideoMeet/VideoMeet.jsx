...
export default function VideoMeetComponent() {
    ...
    let getUserMediaSuccess = (stream)=>{
        ...
        stream.getTracks().forEach(track => track.onended = () => {
            ...
            let blackSilence = (...args) => new MediaStream([blackVideo(...args), silence()])
    ...
    let addMessage = (data, sender, socketIdSender)=>{
        {console.log("addmessage", data, sender, socketIdSender)}
    ...
    return (
        <div>
            ...
            {askForUsername === true ? 
                ...
                <div className={styles.VideoMeetComponent}>
                    ...
                    {showModal? <div className={styles.chatroom}>
                        ...
                        <div className={styles.textBox}>
                            <TextField id="outlined-basic" label="enter a message" onChange={(e)=>{setMessage(e.target.value)}} value={message} variant="outlined" />
                    ...
                    <div className={styles.buttonContainer}>
                        ...
                        <Badge badgeContent={newMessage}  max={999} color="primary">
                                <ChatIcon onClick={()=> setModal(!showModal)}/>
                        </Badge>
                    </div>
